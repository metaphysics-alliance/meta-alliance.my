...
export default function MapCard(){
  ...
  return (
    <section id="location" className="container py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6 items-stretch">
          <div className="text-white/85 text-sm leading-relaxed">
            ...
            <div className="mt-3 space-y-1">
              ...
              <p className="text-white/60 mt-2">{lang==='EN' ? 'Appointments by booking only.' : '只接受预约来访。'}</p>
            </div>
          </div>

          {/* Map — precise pin + corner button. Map stays interactive */}
          <div className="relative rounded-xl overflow-hidden ring-1 ring-white/10 bg-black/20 backdrop-blur-lg">
            ...
            {/* Corner button to open the same coordinates in Google Maps */}
            <a
              href={mapsUrl}
              target="_blank"
