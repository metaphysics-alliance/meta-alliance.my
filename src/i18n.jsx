...
const dict = {
  EN: {
    ...
    who_long: `Metaphysics Alliance, based in Malaysia, is founded on precision and practicality, transforming traditional metaphysics into actionable strategies. We integrate BaZi, Zi Wei Dou Shu, Qi Men Dun Jia, Feng Shui, Huang Ji Shen Shu, Tai Yi Shen Shu, Liu Ren Shen Shu, and Numerical Metaphysics to deliver a holistic understanding of destiny. All analyses are anchored on True Solar Time and the Twenty-Four Solar Terms, ensuring accuracy aligned with natural laws and cosmic rhythms, empowering both life and business decisions.`,
  ...
  vip: {
    section_title: '360 Holistic Destiny Analysis Service',
    cta: 'Learn More',
    tiers: {
  ...
  CN: {
    ...
    brand_bottom: 'Metaphysics Alliance',
    who_title: '我们是谁',
    who_long: '玄域联盟立足马来西亚，以严谨与实用为核心，将传统玄学化为可执行方案。融合八字、紫微、奇门、风水、皇极、太乙、六壬与数字命理，全面剖析命运格局。所有推演以真太阳时与二十四节气为基准，确保结果精准契合自然与宇宙法则，为人生与事业提供前瞻智慧。',
    why_title: '为什么选择我们？',
