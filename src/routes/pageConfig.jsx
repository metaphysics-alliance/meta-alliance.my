...
export const ROUTES = [
  ...
  service('/vip-report/essential', {
    ...
    ideal: 'Ideal for founders, professionals and creators planning their next 18â€“36 months and wanting confidence that each move synchronises with their inherent rhythm.',
  }),
  ...
  },
  {
    ...
    element: (
      <ContentPage
        title="Contact"
        intro="Letâ€™s map out the support you need. Share your intention and preferred timelinesâ€”our team will respond within two business days."
        sections={[
          {
        ...
        sections={[
          {
            ...
            bullets: [
              ...
              'Deliverables are for the clientâ€™s personal or organisational use unless otherwise agreed.',
            ],
          },
          {
            heading: 'Client responsibilities',
            body: 'Clients ensure the accuracy of supplied information and understand metaphysical guidance supplementsâ€”not replacesâ€”professional advice in legal, medical or financial matters.',
          },
        ]}
        cta={CTA_ENQUIRE}
      />
      ...
      <ContentPage
        ...
        sections={[
          ...
          },
          {
            ...
            body: 'Consultations may be rescheduled once with 48 hoursâ€™ notice. No-shows or late cancellations forfeit the session fee.',
          },
        ]}
        cta={CTA_ENQUIRE}
      />
