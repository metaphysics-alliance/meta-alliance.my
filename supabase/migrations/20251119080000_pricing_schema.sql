-- Pricing schema for MVP public pricing tables
-- Mirrors docs/pricing-supabase-schema.md in meta-alliance-mvp
-- Owner: DB Admin (via master-meta-alliance autopilot)
