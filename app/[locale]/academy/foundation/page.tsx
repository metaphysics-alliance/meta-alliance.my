...
export function generateMetadata({ params }: { params: { locale: Locale } }): Metadata {
  ...
  const course = (dict as any).academyFoundation as CourseData | undefined
  const title = course?.hero?.title || 'Chinese Metaphysics Foundation'
  const description = course?.hero?.subtitle || (dict as any).why_long || 'Foundation courses and study path.'
  return {
    title,
    description,
    alternates: {
      canonical: `/${locale}/academy/foundation`,
      languages: { en: '/EN/academy/foundation', zh: '/CN/academy/foundation' }
    },
    openGraph: {
      title,
      description,
      url: `/${locale}/academy/foundation`
    }
  }
}
