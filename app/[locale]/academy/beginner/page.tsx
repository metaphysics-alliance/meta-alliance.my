...
export function generateMetadata({ params }: { params: { locale: Locale } }): Metadata {
  ...
  const course = (dict as any).academyBeginner as CourseData | undefined
  const title = course?.hero?.title || "Beginner's Metaphysic Course"
  const description =
    course?.hero?.subtitle || (dict as any).why_long || 'Beginner courses and introductions.'
  return {
    title,
    description,
    alternates: {
      canonical: `/${locale}/academy/beginner`,
      languages: { en: '/EN/academy/beginner', zh: '/CN/academy/beginner' }
    },
    openGraph: {
      title,
      description,
      url: `/${locale}/academy/beginner`
    }
  }
}
