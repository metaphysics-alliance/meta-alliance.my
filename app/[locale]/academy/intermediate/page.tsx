...
export function generateMetadata({ params }: { params: { locale: Locale } }): Metadata {
  ...
  const course = (dict as any).academyIntermediate as CourseData | undefined
  const title = course?.hero?.title || 'Advanced Course'
  const description =
    course?.hero?.subtitle || (dict as any).why_long || 'Advanced metaphysics integration.'
  return {
    title,
    description,
    alternates: {
      canonical: `/${locale}/academy/intermediate`,
      languages: { en: '/EN/academy/intermediate', zh: '/CN/academy/intermediate' }
    },
    openGraph: {
      title,
      description,
      url: `/${locale}/academy/intermediate`
    }
  }
}
