...
export function generateMetadata({ params }: { params: { locale: Locale } }): Metadata {
  ...
  const title = locale === 'CN' ? '奇门遁甲数据集与工具 - GitHub资源' : 'Qimen Dun Jia Datasets & Tools - GitHub Resources';
  const desc = locale === 'CN' 
    ? '发现GitHub上的奇门遁甲开源数据集、算法库和排盘工具。包含Python、JavaScript、Java等多种语言实现。' 
    : 'Discover open-source Qimen Dun Jia datasets, algorithm libraries, and chart tools on GitHub. Available in Python, JavaScript, Java, and more.';
  return {
    title,
    description: desc,
    alternates: { canonical: `/${locale}/resources/qimen-datasets`, languages: { en: '/EN/resources/qimen-datasets', zh: '/CN/resources/qimen-datasets' } },
    openGraph: { title, description: desc, url: `/${locale}/resources/qimen-datasets` },
  };
}
